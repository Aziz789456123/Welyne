...
T = {
    "fr": {
        ...
        "d_whr":"WHR = tour de taille divise par tour de hanches. Plus il est eleve, plus la graisse est au ventre — risque cardiovasculaire.",
        "d_bf":"Pourcentage de graisse dans le corps, estime par la formule Deurenberg 1991 (IMC + age + sexe).",
        "d_score":"Score 0-100 : tour de taille 40% + WHR 40% + masse grasse 20%. Bases sur les seuils OMS.",
        "imc_cats":{
    ...
    "en": {
        ...
        "d_whr":"WHR = waist divided by hip circumference. Higher value means more belly fat — cardiovascular risk factor.",
        "d_bf":"Body fat percentage estimated by Deurenberg 1991 formula (BMI + age + sex).",
        "d_score":"Score 0-100: waist 40% + WHR 40% + body fat 20%. Based on official WHO thresholds.",
        "imc_cats":{
